...
public sealed class ReservationWriteDtoValidatorTests
{
    ...
    public async Task should_return_error_when_start_date_is_lower_than_today_async()
    {
        ...
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.StartDate) && x.ErrorMessage == $"'Start Date' must be greater than '{Today}'.");
    }
    ...
    public async Task should_return_error_when_start_date_is_empty_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.StartDate) && x.ErrorMessage == "'Start Date' must not be empty.");
    }
    ...
    public async Task should_return_error_when_start_date_is_greater_than_end_day_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.StartDate) && x.ErrorMessage == $"'Start Date' must be less than '{ValidDate}'.");
    }
    ...
    public async Task should_return_error_when_end_date_is_lower_than_today_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.EndDate) && x.ErrorMessage == $"'End Date' must be greater than '{Today}'.");
    }
    ...
    public async Task should_return_error_when_end_date_is_empty_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.EndDate) && x.ErrorMessage == "'End Date' must not be empty.");
    }
    ...
    public async Task should_return_error_when_end_date_is_lower_than_end_day_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.EndDate) && x.ErrorMessage == $"'End Date' must be greater than '{ValidDate.AddDays(1)}'.");
    }
    ...
    public async Task should_return_error_when_equipmentId_is_empty_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.EquipmentId) && x.ErrorMessage == "'Equipment Id' must not be empty.");
    }
    ...
    public async Task should_return_error_when_quantity_is_zero_async()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().NotBeEmpty();
        result.Errors.Should().Contain(x => x.PropertyName == nameof(ReservationWriteDto.Quantity) && x.ErrorMessage == "'Quantity' must be greater than '0'.");
    }
}